...
#if QT_CONFIG(tooltip)
        self.radioButtonSimple.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Background will have selected color", None))
#endif // QT_CONFIG(tooltip)
        self.radioButtonSimple.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Simple color", None))
#if QT_CONFIG(tooltip)
        self.radioButtonGradient.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Background will have selected color gradient", None))
#endif // QT_CONFIG(tooltip)
        self.radioButtonGradient.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Linear gradient", None))
#if QT_CONFIG(tooltip)
        self.rbRadialGradient.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Background will have selected color gradient", None))
#endif // QT_CONFIG(tooltip)
        self.rbRadialGradient.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Radial gradient", None))
#if QT_CONFIG(tooltip)
        self.SelectionColor_Background.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Background will have selected color", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkMidColor.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Color gradient will get selected color as middle color", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.TreeEditColor.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Background color for objects in tree view that are currently edited", None))
#endif // QT_CONFIG(tooltip)
        self.label_3.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Active container", None))
#if QT_CONFIG(tooltip)
        self.TreeActiveColor.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Background color for active containers in tree view", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.CbLabelColor.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Color Bar (used in Mesh and FEM Wbs) Label text color", None))
#endif // QT_CONFIG(tooltip)
        self.label_CbLabelTextSize.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Label text size", None))
#if QT_CONFIG(tooltip)
        self.CbLabelTextSize.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsViewColor", u"Color Bar (used in Mesh and FEM Wbs) Label Text Size", None))
#endif // QT_CONFIG(tooltip)
