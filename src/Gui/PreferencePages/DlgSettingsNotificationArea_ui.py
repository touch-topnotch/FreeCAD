...
#if QT_CONFIG(tooltip)
        self.NonIntrusiveNotificationsEnabled.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsNotificationArea", u"If checked, non-intrusive pop-up notifications will appear above the status bar, around the notification area. Pop-up notifications can be manually dismissed by clicking on them, and also automatically dismissed by specifying a maximum and minimum duration for them to be displayed.\n"
"\n"
