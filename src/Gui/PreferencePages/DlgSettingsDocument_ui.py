...
#endif // QT_CONFIG(tooltip)
        self.prefUndoRedo.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsDocument", u"Using undo/redo in documents", None))
...
#endif // QT_CONFIG(tooltip)
        self.prefSaveThumbnail.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsDocument", u"Add thumbnail to project file when saving", None))
...
#if QT_CONFIG(tooltip)
        self.prefAddLogo.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsDocument", u"The program icon will be added to the thumbnail", None))
#endif // QT_CONFIG(tooltip)
        self.prefAddLogo.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsDocument", u"Add program icon to the generated thumbnail", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.prefAutoSaveEnabled.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsDocument", u"Save auto-recovery information every", None))
#if QT_CONFIG(tooltip)
