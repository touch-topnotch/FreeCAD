...
"horizontal space in Python console", None))
        ...
        self.labelProfilerInterval.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsPythonConsole", u"Python profiler interval (milliseconds):", None))
#if QT_CONFIG(tooltip)
        self.ProfilerInterval.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsPythonConsole", u"The interval at which the profiler runs when there's Python code running (to keep the GUI responding). Set to 0 to disable.", None))
#endif // QT_CONFIG(tooltip)
