...
class Ui_Gui_Dialog_DlgSettingsLightSources(object):
    ...
    def retranslateUi(self, Gui__Dialog__DlgSettingsLightSources):
        ...
        self.groupBoxDirection.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsLightSources", u"Adjust the orientation of the directional light source by dragging the handle with the mouse or use the spin boxes for fine tuning.", None))
#endif // QT_CONFIG(tooltip)
        self.groupBoxDirection.setTitle(QCoreApplication.translate("Gui::Dialog::DlgSettingsLightSources", u"Preview", None))
#if QT_CONFIG(tooltip)
        self.zoomInButton.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsLightSources", u"Push In", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.zoomOutButton.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsLightSources", u"Pull Out", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.backLightEnable.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsLightSources", u"Back Light", None))
