...
class Ui_Gui_TaskImage(object):
    ...
    def retranslateUi(self, Gui__TaskImage):
        ...
        self.pushButtonScale.setToolTip(QCoreApplication.translate("Gui::TaskImage", u"Scales the image interactively by setting a length between two points of the image", None))
