...
#if QT_CONFIG(tooltip)
        self.UnitInput.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgUnitCalculator", u"Input here the unit for the result", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.pushButton_Copy.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgUnitCalculator", u"Copy the result into the clipboard", None))
#endif // QT_CONFIG(tooltip)
