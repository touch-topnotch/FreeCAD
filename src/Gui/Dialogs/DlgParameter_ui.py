...
class Ui_Gui_Dialog_DlgParameter(object):
    ...
    def retranslateUi(self, Gui__Dialog__DlgParameter):
        ...
        self.quickSearch.setText(QCoreApplication.translate("Gui::Dialog::DlgParameter", u"Quick search", None))
#if QT_CONFIG(tooltip)
        self.findGroupLE.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgParameter", u"Type in a group name to find it", None))
        ...
        self.buttonSaveToDisk.setText(QCoreApplication.translate("Gui::Dialog::DlgParameter", u"Save to disk", None))
