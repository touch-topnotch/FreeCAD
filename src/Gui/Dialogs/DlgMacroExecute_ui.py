...
#if QT_CONFIG(tooltip)
        self.LineEditFindInFiles.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgMacroExecute", u"Filter by file content, case-insensitive. Regular expressions are supported.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.toolbarButton.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgMacroExecute", u"Launches a guide on how to set up a macro in a custom global toolbar", None))
#endif // QT_CONFIG(tooltip)
        self.toolbarButton.setText(QCoreApplication.translate("Gui::Dialog::DlgMacroExecute", u"Toolbar", None))
#if QT_CONFIG(tooltip)
        self.addonsButton.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgMacroExecute", u"Opens the Addon Manager to download macros created by the community", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.folderButton.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgMacroExecute", u"Opens the macros folder in the system file manager", None))
#endif // QT_CONFIG(tooltip)
