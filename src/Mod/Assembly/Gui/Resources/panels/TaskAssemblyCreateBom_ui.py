...
class Ui_TaskAssemblyCreateView(object):
    ...
    def retranslateUi(self, TaskAssemblyCreateBom):
        TaskAssemblyCreateBom.setWindowTitle(QCoreApplication.translate("TaskAssemblyCreateView", u"Create Bill Of Materials", None))
#if QT_CONFIG(tooltip)
        self.CheckBox_detailSubAssemblies.setToolTip(QCoreApplication.translate("TaskAssemblyCreateView", u"If checked, Sub assemblies children will be added to the bill of materials.", None))
...
#if QT_CONFIG(tooltip)
        self.CheckBox_detailParts.setToolTip(QCoreApplication.translate("TaskAssemblyCreateView", u"If checked, Parts children will be added to the bill of materials.", None))
#endif // QT_CONFIG(tooltip)
        self.CheckBox_detailParts.setText(QCoreApplication.translate("TaskAssemblyCreateView", u"Parts children", None))
#if QT_CONFIG(tooltip)
        self.CheckBox_onlyParts.setToolTip(QCoreApplication.translate("TaskAssemblyCreateView", u"If checked, only Part containers and sub-assemblies will be added to the bill of materials. Solids like PartDesign Bodies, fasteners or Part workbench primitives will be ignored.", None))
#endif // QT_CONFIG(tooltip)
