...
class Ui_TaskAssemblyCreateJoint(object):
    ...
    def retranslateUi(self, TaskAssemblyCreateJoint):
        TaskAssemblyCreateJoint.setWindowTitle(QCoreApplication.translate("TaskAssemblyCreateJoint", u"Joint", None))
        ...
        self.offset1Button.setToolTip(QCoreApplication.translate("TaskAssemblyCreateJoint", u"Sets the attachment offset of the joint\u2019s first marker (coordinate system)", None))
...
#if QT_CONFIG(tooltip)
        self.offset2Button.setToolTip(QCoreApplication.translate("TaskAssemblyCreateJoint", u"Sets the attachment offset of the second marker (coordinate system) of the joint", None))
#endif // QT_CONFIG(tooltip)
