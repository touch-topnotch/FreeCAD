...
class Ui_MeshPartGui_CrossSections(object):
    def setupUi(self, MeshPartGui__CrossSections):
        if not MeshPartGui__CrossSections.objectName():
            MeshPartGui__CrossSections.setObjectName(u"MeshPartGui__CrossSections")
        MeshPartGui__CrossSections.resize(309, 269)
        self.gridLayout_4 = QGridLayout(MeshPartGui__CrossSections)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.planeBox = QGroupBox(MeshPartGui__CrossSections)
        ...
        self.sectionsBox = QGroupBox(MeshPartGui__CrossSections)
        ...
        self.groupBox = QGroupBox(MeshPartGui__CrossSections)
        self.groupBox.setObjectName(u"groupBox")
        self.gridLayout_5 = QGridLayout(self.groupBox)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.checkBoxConnect = QCheckBox(self.groupBox)
        self.checkBoxConnect.setObjectName(u"checkBoxConnect")

        self.gridLayout_5.addWidget(self.checkBoxConnect, 0, 0, 1, 1)

        self.spinEpsilon = QDoubleSpinBox(self.groupBox)
        self.spinEpsilon.setObjectName(u"spinEpsilon")
        self.spinEpsilon.setEnabled(False)
        self.spinEpsilon.setDecimals(4)
        self.spinEpsilon.setValue(0.020000000000000)

        self.gridLayout_5.addWidget(self.spinEpsilon, 0, 1, 1, 1)
        ...
        self.retranslateUi(MeshPartGui__CrossSections)
        self.checkBoxConnect.toggled.connect(self.spinEpsilon.setEnabled)

        QMetaObject.connectSlotsByName(MeshPartGui__CrossSections)
    # setupUi

    def retranslateUi(self, MeshPartGui__CrossSections):
        MeshPartGui__CrossSections.setWindowTitle(QCoreApplication.translate("MeshPartGui::CrossSections", u"Cross Sections", None))
        self.planeBox.setTitle(QCoreApplication.translate("MeshPartGui::CrossSections", u"Guiding Plane", None))
        self.xyPlane.setText(QCoreApplication.translate("MeshPartGui::CrossSections", u"XY", None))
        self.xzPlane.setText(QCoreApplication.translate("MeshPartGui::CrossSections", u"XZ", None))
        self.yzPlane.setText(QCoreApplication.translate("MeshPartGui::CrossSections", u"YZ", None))
        self.label.setText(QCoreApplication.translate("MeshPartGui::CrossSections", u"Position", None))
        self.sectionsBox.setTitle(QCoreApplication.translate("MeshPartGui::CrossSections", u"Sections", None))
        self.checkBothSides.setText(QCoreApplication.translate("MeshPartGui::CrossSections", u"On both sides", None))
        self.label_3.setText(QCoreApplication.translate("MeshPartGui::CrossSections", u"Count", None))
        self.label_2.setText(QCoreApplication.translate("MeshPartGui::CrossSections", u"Distance", None))
        self.groupBox.setTitle(QCoreApplication.translate("MeshPartGui::CrossSections", u"Options", None))
        self.checkBoxConnect.setText(QCoreApplication.translate("MeshPartGui::CrossSections", u"Connect edges if distance less than", None))
    # retranslateUi
