...
#endif // QT_CONFIG(tooltip)
        self.checkBox_showPlaneTracker.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Show working plane orientation", None))
#if QT_CONFIG(tooltip)
...
"accidentally and modifying the entered value.", None))
        ...
        self.label_DraftEditMaxObjects.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Maximum number of editable objects", None))
#if QT_CONFIG(tooltip)
