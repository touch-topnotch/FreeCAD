...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 383, 732))
        ...
        self.ArrowTypeStart = QComboBox(self.groupBox_4)
        self.ArrowTypeStart.addItem("")
        self.ArrowTypeStart.addItem("")
        self.ArrowTypeStart.addItem("")
        self.ArrowTypeStart.addItem("")
        self.ArrowTypeStart.addItem("")
        self.ArrowTypeStart.addItem("")
        self.ArrowTypeStart.setObjectName(u"ArrowTypeStart")
        sizePolicy1.setHeightForWidth(self.ArrowTypeStart.sizePolicy().hasHeightForWidth())
        self.ArrowTypeStart.setSizePolicy(sizePolicy1)
        self.ArrowTypeStart.setMinimumSize(QSize(60, 0))

        self.gridLayout_3.addWidget(self.ArrowTypeStart, 3, 1, 1, 1)

        self.label_ArrowSizeStart = QLabel(self.groupBox_4)
        self.label_ArrowSizeStart.setObjectName(u"label_ArrowSizeStart")

        self.gridLayout_3.addWidget(self.label_ArrowSizeStart, 4, 0, 1, 1)

        self.ArrowSizeStart = Gui_InputField(self.groupBox_4)
        self.ArrowSizeStart.setObjectName(u"ArrowSizeStart")
        self.ArrowSizeStart.setProperty(u"unit", u"")

        self.gridLayout_3.addWidget(self.ArrowSizeStart, 4, 1, 1, 1)

        self.label_ArrowTypeEnd = QLabel(self.groupBox_4)
        self.label_ArrowTypeEnd.setObjectName(u"label_ArrowTypeEnd")

        self.gridLayout_3.addWidget(self.label_ArrowTypeEnd, 5, 0, 1, 1)

        self.ArrowTypeEnd = QComboBox(self.groupBox_4)
        self.ArrowTypeEnd.addItem("")
        self.ArrowTypeEnd.addItem("")
        self.ArrowTypeEnd.addItem("")
        self.ArrowTypeEnd.addItem("")
        self.ArrowTypeEnd.addItem("")
        self.ArrowTypeEnd.addItem("")
        self.ArrowTypeEnd.setObjectName(u"ArrowTypeEnd")
        sizePolicy1.setHeightForWidth(self.ArrowTypeEnd.sizePolicy().hasHeightForWidth())
        self.ArrowTypeEnd.setSizePolicy(sizePolicy1)
        self.ArrowTypeEnd.setMinimumSize(QSize(60, 0))

        self.gridLayout_3.addWidget(self.ArrowTypeEnd, 5, 1, 1, 1)

        self.label_ArrowSizeEnd = QLabel(self.groupBox_4)
        self.label_ArrowSizeEnd.setObjectName(u"label_ArrowSizeEnd")

        self.gridLayout_3.addWidget(self.label_ArrowSizeEnd, 6, 0, 1, 1)

        self.ArrowSizeEnd = Gui_InputField(self.groupBox_4)
        self.ArrowSizeEnd.setObjectName(u"ArrowSizeEnd")
        self.ArrowSizeEnd.setProperty(u"unit", u"")

        self.gridLayout_3.addWidget(self.ArrowSizeEnd, 6, 1, 1, 1)

        self.label_LineColor = QLabel(self.groupBox_4)
        self.label_LineColor.setObjectName(u"label_LineColor")

        self.gridLayout_3.addWidget(self.label_LineColor, 7, 0, 1, 1)

        self.LineColor = Gui_ColorButton(self.groupBox_4)
        self.LineColor.setObjectName(u"LineColor")

        self.gridLayout_3.addWidget(self.LineColor, 7, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBoxStyles.setToolTip(QCoreApplication.translate("Dialog", u"The name of the style. Existing style names can be edited.", None))
...
#if QT_CONFIG(tooltip)
        self.label_ShowLine.setToolTip(QCoreApplication.translate("Dialog", u"Displays the dimension line", None))
#endif // QT_CONFIG(tooltip)
        self.label_ShowLine.setText(QCoreApplication.translate("Dialog", u"Show dimension line", None))
#if QT_CONFIG(tooltip)
        self.ShowLine.setToolTip(QCoreApplication.translate("Dialog", u"Displays the dimension line", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.label_ArrowType.setToolTip(QCoreApplication.translate("Dialog", u"The type of the starting arrows or markers to use for dimensions and labels", None))
#endif // QT_CONFIG(tooltip)
        self.label_ArrowType.setText(QCoreApplication.translate("Dialog", u"Start arrow type", None))
        self.ArrowTypeStart.setItemText(0, QCoreApplication.translate("Dialog", u"Dot", None))
        self.ArrowTypeStart.setItemText(1, QCoreApplication.translate("Dialog", u"Circle", None))
        self.ArrowTypeStart.setItemText(2, QCoreApplication.translate("Dialog", u"Arrow", None))
        self.ArrowTypeStart.setItemText(3, QCoreApplication.translate("Dialog", u"Tick", None))
        self.ArrowTypeStart.setItemText(4, QCoreApplication.translate("Dialog", u"Tick-2", None))
        self.ArrowTypeStart.setItemText(5, QCoreApplication.translate("Dialog", u"None", None))

#if QT_CONFIG(tooltip)
        self.ArrowTypeStart.setToolTip(QCoreApplication.translate("Dialog", u"The type of the starting arrows or markers to use for dimensions and labels", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.label_ArrowSizeStart.setToolTip(QCoreApplication.translate("Dialog", u"The size of the starting arrows or markers in system units", None))
#endif // QT_CONFIG(tooltip)
        self.label_ArrowSizeStart.setText(QCoreApplication.translate("Dialog", u"Start arrow size", None))
#if QT_CONFIG(tooltip)
        self.ArrowSizeStart.setToolTip(QCoreApplication.translate("Dialog", u"The size of the starting arrows or markers in system units", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.label_ArrowTypeEnd.setToolTip(QCoreApplication.translate("Dialog", u"The type of the ending arrows or markers to use for dimensions and labels", None))
#endif // QT_CONFIG(tooltip)
        self.label_ArrowTypeEnd.setText(QCoreApplication.translate("Dialog", u"End arrow type", None))
        self.ArrowTypeEnd.setItemText(0, QCoreApplication.translate("Dialog", u"Dot", None))
        self.ArrowTypeEnd.setItemText(1, QCoreApplication.translate("Dialog", u"Circle", None))
        self.ArrowTypeEnd.setItemText(2, QCoreApplication.translate("Dialog", u"Arrow", None))
        self.ArrowTypeEnd.setItemText(3, QCoreApplication.translate("Dialog", u"Tick", None))
        self.ArrowTypeEnd.setItemText(4, QCoreApplication.translate("Dialog", u"Tick-2", None))
        self.ArrowTypeEnd.setItemText(5, QCoreApplication.translate("Dialog", u"None", None))

#if QT_CONFIG(tooltip)
        self.ArrowTypeEnd.setToolTip(QCoreApplication.translate("Dialog", u"The type of the ending arrows or markers to use for dimensions and labels", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.label_ArrowSizeEnd.setToolTip(QCoreApplication.translate("Dialog", u"The size of the ending arrows or markers in system units", None))
#endif // QT_CONFIG(tooltip)
        self.label_ArrowSizeEnd.setText(QCoreApplication.translate("Dialog", u"End arrow size", None))
#if QT_CONFIG(tooltip)
        self.ArrowSizeEnd.setToolTip(QCoreApplication.translate("Dialog", u"The size of the ending arrows or markers in system units", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.ShowUnit.setToolTip(QCoreApplication.translate("Dialog", u"Shows the unit next to the dimension value", None))
#endif // QT_CONFIG(tooltip)
