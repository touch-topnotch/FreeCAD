...
class Ui_Gui_Dialog_DlgSettingsDraft(object):
    def setupUi(self, Gui__Dialog__DlgSettingsDraft):
        ...
        Gui__Dialog__DlgSettingsDraft.resize(555, 797)
        ...
        self.label_dimsymbol = QLabel(self.groupBox_3)
        self.label_dimsymbol.setObjectName(u"label_dimsymbol")

        self.gridLayout_3.addWidget(self.label_dimsymbol, 2, 0, 1, 1)

        self.comboBox_dimsymbol = Gui_PrefComboBox(self.groupBox_3)
        self.comboBox_dimsymbol.addItem("")
        self.comboBox_dimsymbol.addItem("")
        self.comboBox_dimsymbol.addItem("")
        self.comboBox_dimsymbol.addItem("")
        self.comboBox_dimsymbol.addItem("")
        self.comboBox_dimsymbol.setObjectName(u"comboBox_dimsymbol")
        self.comboBox_dimsymbol.setMinimumSize(QSize(140, 0))
        self.comboBox_dimsymbol.setProperty(u"prefEntry", u"dimsymbol")
        self.comboBox_dimsymbol.setProperty(u"prefPath", u"Mod/Draft")

        self.gridLayout_3.addWidget(self.comboBox_dimsymbol, 2, 1, 1, 1)

        self.label_arrowsize = QLabel(self.groupBox_3)
        self.label_arrowsize.setObjectName(u"label_arrowsize")

        self.gridLayout_3.addWidget(self.label_arrowsize, 3, 0, 1, 1)

        self.spinBox_arrowsize = Gui_PrefUnitSpinBox(self.groupBox_3)
        self.spinBox_arrowsize.setObjectName(u"spinBox_arrowsize")
        self.spinBox_arrowsize.setSingleStep(0.100000000000000)
        self.spinBox_arrowsize.setMinimum(0.000000000000000)
        self.spinBox_arrowsize.setProperty(u"rawValue", 1.000000000000000)
        self.spinBox_arrowsize.setProperty(u"prefEntry", u"arrowsize")
        self.spinBox_arrowsize.setProperty(u"prefPath", u"Mod/Draft")

        self.gridLayout_3.addWidget(self.spinBox_arrowsize, 3, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_DefaultAnnoLineColor, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.colorButton_DefaultAnnoLineColor, 4, 1, 1, 1)
...
"in the Annotation scale widget. If the scale is 1:100 the multiplier is 100.", None))
        ...
        self.label_dimsymbol.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Arrow type", None))
        self.comboBox_dimsymbol.setItemText(0, QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Dot", None))
        self.comboBox_dimsymbol.setItemText(1, QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Circle", None))
        self.comboBox_dimsymbol.setItemText(2, QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Arrow", None))
        self.comboBox_dimsymbol.setItemText(3, QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Tick", None))
        self.comboBox_dimsymbol.setItemText(4, QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Tick-2", None))

#if QT_CONFIG(tooltip)
        self.comboBox_dimsymbol.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"The default symbol displayed at the ends of dimension lines", None))
#endif // QT_CONFIG(tooltip)
        self.label_arrowsize.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"Arrow size", None))
#if QT_CONFIG(tooltip)
        self.spinBox_arrowsize.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"The default arrow size", None))
#endif // QT_CONFIG(tooltip)
        self.spinBox_arrowsize.setProperty(u"unit", QCoreApplication.translate("Gui::Dialog::DlgSettingsDraft", u"mm", None))
