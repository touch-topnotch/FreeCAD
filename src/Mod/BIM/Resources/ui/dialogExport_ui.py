...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkAskBeforeSaving = QCheckBox(Dialog)
        self.checkAskBeforeSaving.setObjectName(u"checkAskBeforeSaving")
        self.checkAskBeforeSaving.setChecked(True)

        self.verticalLayout.addWidget(self.checkAskBeforeSaving)
