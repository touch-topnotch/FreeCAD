...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.checkOnline.setToolTip(QCoreApplication.translate("Form", u"Allows the library to be fetched online instead of requiring local installation.", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.checkWebSearch.setText(QCoreApplication.translate("Form", u"Search using FreeCAD's web view", None))
#if QT_CONFIG(tooltip)
