...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"This screen allows you to create and configure a new BIM project in FreeCAD.", None))
...
#if QT_CONFIG(tooltip)
        self.buttonSave.setToolTip(QCoreApplication.translate("Dialog", u"The settings below can be saved as a preset. Presets are stored as .txt files in your FreeCAD user folder", None))
#endif // QT_CONFIG(tooltip)
        self.buttonSave.setText(QCoreApplication.translate("Dialog", u"Save preset", None))
#if QT_CONFIG(tooltip)
        self.groupNewProject.setToolTip(QCoreApplication.translate("Dialog", u"Create a new BIM project", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.radioNative1.setToolTip(QCoreApplication.translate("Dialog", u"This will create a new FreeCAD document that allows you to build a BIM model, but with no specific IFC structure yet. This is the most flexible option when you start working ona BIM project. You can convert this project to IFC anytime later.", None))
#endif // QT_CONFIG(tooltip)
        self.radioNative1.setText(QCoreApplication.translate("Dialog", u"Create a new document without IFC support yet", None))
#if QT_CONFIG(tooltip)
        self.radioNative2.setToolTip(QCoreApplication.translate("Dialog", u"This will create an IFC project. All the BIM objects you will add to that IFC project will immediately become IFC objects. This is less flexible, but allows you to stick more strictly to the IFC standard.", None))
#endif // QT_CONFIG(tooltip)
        self.radioNative2.setText(QCoreApplication.translate("Dialog", u"Create a Native IFC project in the current document", None))
#if QT_CONFIG(tooltip)
        self.radioNative3.setToolTip(QCoreApplication.translate("Dialog", u"The new IFC project will be created as a new FreeCAD document.  In that mode, the IFC project is the FreeCAD document, anything you create in that document becomes part of the IFC project. This is extremely restrictive as no non-IFC object can be added to the document.", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.label_19.setText(QCoreApplication.translate("Dialog", u"The site object contains all the data relative to the project location. Later on, you can attach a physical object representing the terrain.", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.groupBuilding.setToolTip(QCoreApplication.translate("Dialog", u"Create a new building", None))
#endif // QT_CONFIG(tooltip)
        self.groupBuilding.setTitle(QCoreApplication.translate("Dialog", u"Create building", None))
        self.label_15.setText(QCoreApplication.translate("Dialog", u"This will configure a single building for this project. If your project is made of several buildings, you can duplicate it after creation and update its properties.", None))
...
#if QT_CONFIG(tooltip)
        self.buildingUse.setToolTip(QCoreApplication.translate("Dialog", u"The main use of this building", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.label_29.setText(QCoreApplication.translate("Dialog", u"Main use", None))
#if QT_CONFIG(tooltip)
        self.countHAxes.setToolTip(QCoreApplication.translate("Dialog", u"Number of horizontal axes", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.buildingWidth.setToolTip(QCoreApplication.translate("Dialog", u"An estimate building width. Keep 0 if you don't want to specify this now", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.buildingLength.setToolTip(QCoreApplication.translate("Dialog", u"An estimate building length. Keep 0 if you don't want to specify this now", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.addHumanFigure.setTitle(QCoreApplication.translate("Dialog", u"Add a human figure", None))
        self.label_10.setText(QCoreApplication.translate("Dialog", u"A human figure will be added to the document, which helps giving a sense of scale", None))
        self.groupBox.setTitle(QCoreApplication.translate("Dialog", u"Levels", None))
        self.label_9.setText(QCoreApplication.translate("Dialog", u"BIM projects are typically organized into levels, that represents the different storeys of a building. Although it is not mandatory to work with levels in FreeCAD, you can set up default levels here", None))
#if QT_CONFIG(tooltip)
        ...
        self.label_34.setText(QCoreApplication.translate("Dialog", u"Default groups to be added to each level. Default groups such as walls, windows,... are useful to organize the different building elements inside a level", None))
#if QT_CONFIG(tooltip)
        self.groupsList.setToolTip(QCoreApplication.translate("Dialog", u"A list of grouls to add under each level", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.buttonAdd.setToolTip(QCoreApplication.translate("Dialog", u"Add a new group", None))
#endif // QT_CONFIG(tooltip)
