...
class Ui_BIMSetupDialog(object):
    ...
    def retranslateUi(self, BIMSetupDialog):
        ...
        self.label_2.setText(QCoreApplication.translate("BIMSetupDialog", u"This dialog will help set FreeCAD up for efficient BIM workflow by setting a couple FreeCAD options. This dialog can be accessed again anytime from menu Manage -> Setup, and more options are available under the edit -> preferences menu.", None))
        self.label_18.setText(QCoreApplication.translate("BIMSetupDialog", u"Hover the mouse on each setting for additional info", None))
        ...
        self.comboPresets.setItemText(0, QCoreApplication.translate("BIMSetupDialog", u"Choose the preferred working unit", None))
...
#if QT_CONFIG(tooltip)
        self.comboPresets.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"Choose one of the presets in this list to fill all the settings below with predetermined values", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.settingUnits.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p>The preferred unit that will be used everywhere: in dialogs, measurements and dimensions. However, any other unit can be entered anytime. Changing the default unit system anytime will not cause any modification to the model. Location in preferences: <span style=\" font-weight:600;\">General &gt; Default unit system</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.settingDecimals.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p>The number of decimals preferred in the interface controls and measurements. Location in preferences: <span style=\" font-weight:600;\">General &gt; Units &gt; Number of decimals</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.colorButtonFaces.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p>The default color of faces in the 3D view. Location in preferences: <span style=\" font-weight:600;\">Display &gt; Part/Part Design Color &gt; Shape Appearance &gt; Shape color</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.colorButtonHelpers.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p>The default color for helper objects such as grids and axes. Location in preferences: <span style=\" font-weight:600;\">BIM  &gt; Defaults &gt; Helper colors</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_23.setText(QCoreApplication.translate("BIMSetupDialog", u"Lines", None))
#if QT_CONFIG(tooltip)
        self.colorButtonLines.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p>The default color of lines in the 3D view. Location in preferences: <span style=\" font-weight:600;\">Display &gt; Part/Part Design Color &gt; Shape Appearance &gt; Default line color</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.colorButtonSimple.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"The background color when simple color is enabled", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.settingCameraHeight.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"The altitude of the camera when a blank file is created. Recommended values are between 5 (view a few centimeters wide) and 5000 (view a few meters wide)", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.settingAuthor.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p>Name (optional). You can also add an email address like this: John Doe &lt;john@doe.com&gt;. Location in preferences: <span style=\" font-weight:600;\">General &gt; Document &gt; Author name</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.settingLicense.setToolTip(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p>Optional license to use for new files. Keep &quot;All rights reserved&quot; if no license is preferred. Location in preferences: <span style=\" font-weight:600;\">General &gt; Document &gt; Default license</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.labelSnapTip.setText(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p><span style=\" font-weight:600;\">Tip</span>: The appropriate snapping modes on the Snapping toolbar can be set. Enabling only the snap positions needed will make drawing in FreeCAD considerably faster.</p></body></html>", None))
        self.labelVersion.setText(QCoreApplication.translate("BIMSetupDialog", u"<html><head/><body><p><b>Tip</b>: The currently installed FreeCAD version is %1. Consider using the <a href=\"https://github.com/FreeCAD/FreeCAD/releases\"><span style=\" text-decoration: underline; color:#0000ff;\">latest development version %2</span></a>, which brings all the latest improvements to FreeCAD.</p></body></html>", None))
