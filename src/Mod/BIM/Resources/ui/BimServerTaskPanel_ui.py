...
class Ui_BimServer(object):
    ...
    def retranslateUi(self, BimServer):
        BimServer.setWindowTitle(QCoreApplication.translate("BimServer", u"BimServer", None))
        self.groupServer.setTitle(QCoreApplication.translate("BimServer", u"Server", None))
#if QT_CONFIG(tooltip)
        self.labelServerName.setToolTip(QCoreApplication.translate("BimServer", u"The name of the BIM Server you are currently connecting to. Change settings in the BIM preferences", None))
