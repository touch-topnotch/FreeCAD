...
class Ui_Gui_Dialog_DlgSettingsArch(object):
    ...
    def retranslateUi(self, Gui__Dialog__DlgSettingsArch):
        ...
        self.checkBox_debugGeometry.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsArch", u"DEBUG: keep the construction geometries in the ActiveDocument. Useful when debugging a failed import", None))
...
#if QT_CONFIG(tooltip)
        self.checkBox_9.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsArch", u"Merge imported element with existing FC object", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkBox_10.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsArch", u"Create a default Render project with the newly created Site", None))
#endif // QT_CONFIG(tooltip)
        self.checkBox_10.setText(QCoreApplication.translate("Gui::Dialog::DlgSettingsArch", u"Create Render Project (requires Render)", None))
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.checkBox_decorate_surfaces.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsArch", u"Create Facebinders, Baseboards for walls, floors and ceilings for Rooms", None))
#endif // QT_CONFIG(tooltip)
