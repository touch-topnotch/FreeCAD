...
class Ui_Gui_Dialog_DlgSettingsArch(object):
    ...
    def retranslateUi(self, Gui__Dialog__DlgSettingsArch):
        ...
        self.checkBox_joinWallSketches.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsArch", u"When two similar walls are connected, their underlying sketches are merged and the walls are combined into a single object", None))
...
#if QT_CONFIG(tooltip)
        self.checkBox_MoveWithHost.setToolTip(QCoreApplication.translate("Gui::Dialog::DlgSettingsArch", u"By default, new objects will have their \"Move with host\" property set to False, which means they will not move when their host object is moved", None))
#endif // QT_CONFIG(tooltip)
