...
class Ui_FemGui_DlgSettingsFemCcxImp(object):
    ...
    def retranslateUi(self, FemGui__DlgSettingsFemCcxImp):
        ...
        self.l_ccx_initial_time_step.setText(QCoreApplication.translate("FemGui::DlgSettingsFemCcxImp", u"Initial time step", None))
        self.l_ccx_analysis_time.setText(QCoreApplication.translate("FemGui::DlgSettingsFemCcxImp", u"End time", None))
        self.cb_use_iterations_param.setText(QCoreApplication.translate("FemGui::DlgSettingsFemCcxImp", u"Use non ccx defaults", None))
        self.l_ccx_numcpu.setText(QCoreApplication.translate("FemGui::DlgSettingsFemCcxImp", u"Number of CPUs to use", None))
        ...
        self.l_ccx_minimum_time_step.setText(QCoreApplication.translate("FemGui::DlgSettingsFemCcxImp", u"Minimum time step", None))
        ...
        self.l_ccx_maximum_time_step.setText(QCoreApplication.translate("FemGui::DlgSettingsFemCcxImp", u"Maximum time step", None))
