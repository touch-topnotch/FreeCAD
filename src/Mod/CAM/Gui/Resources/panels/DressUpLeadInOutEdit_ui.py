...
#if QT_CONFIG(tooltip)
        self.dspExtendIn.setToolTip(QCoreApplication.translate("CAM_DressupLeadInOut", u"extends the leadin distance", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.dspExtendOut.setToolTip(QCoreApplication.translate("CAM_DressupLeadInOut", u"Extends the leadout distance", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
