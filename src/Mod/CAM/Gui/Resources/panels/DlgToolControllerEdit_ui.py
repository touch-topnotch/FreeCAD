...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.toolBoxPage1 = QWidget(Dialog)
        self.toolBoxPage1.setObjectName(u"toolBoxPage1")
        self.tc_layout = QVBoxLayout(self.toolBoxPage1)
        self.tc_layout.setObjectName(u"tc_layout")
        self.tc_layout.setContentsMargins(0, 0, 0, 0)

        self.verticalLayout.addWidget(self.toolBoxPage1)
