...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.KeepToolDownEnabled, 2, 1, 1, 1)

        self.editToolController = QCheckBox(self.frame)
        self.editToolController.setObjectName(u"editToolController")

        self.gridLayout_2.addWidget(self.editToolController, 3, 0, 1, 2)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.KeepToolDownEnabled.setToolTip(QCoreApplication.translate("Form", u"Do not retract after every hole", None))
#endif // QT_CONFIG(tooltip)
