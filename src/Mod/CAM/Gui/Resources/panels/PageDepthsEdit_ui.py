...
#if QT_CONFIG(tooltip)
        self.stepDown.setToolTip(QCoreApplication.translate("Form", u"The depth in Z-axis the operation moves downwards between layers. This value depends on the tool being used, the material to be cut, available cooling and many other factors. Consult the tool manufacturers data sheets for the proper value.", None))
#endif // QT_CONFIG(tooltip)
