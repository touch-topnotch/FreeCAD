...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.layerMode, 2, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.boundBoxExtraOffset_label, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.depthOffset, 9, 1, 1, 2)

        self.stepOver_label = QLabel(self.widget)
        self.stepOver_label.setObjectName(u"stepOver_label")

        self.gridLayout.addWidget(self.stepOver_label, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.stepOver, 10, 1, 1, 2)

        self.sampleInterval_label = QLabel(self.widget)
        self.sampleInterval_label.setObjectName(u"sampleInterval_label")

        self.gridLayout.addWidget(self.sampleInterval_label, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.boundaryEnforcement, 15, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.optimizeStepOverTransitions, 15, 1, 1, 1)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.useStartPoint.setToolTip(QCoreApplication.translate("Form", u"Make True, if specifying a Start Point", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.boundaryEnforcement.setToolTip(QCoreApplication.translate("Form", u"If true, the cutter will remain inside the boundaries of the model or selected face(s)", None))
#endif // QT_CONFIG(tooltip)
