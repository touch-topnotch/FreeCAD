...
################################################################################
## Form generated from reading UI file 'DlgSelectPostProcessor.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lwPostProcessor = QListWidget(Dialog)
        self.lwPostProcessor.setObjectName(u"lwPostProcessor")
        self.lwPostProcessor.setGeometry(QRect(20, 30, 351, 191))
