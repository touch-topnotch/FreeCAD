...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.propertyName.setToolTip(QCoreApplication.translate("Dialog", u"Name of the property. Can only contain letters, numbers, and underscores. MixedCase names will display with spaces \"Mixed Case\"", None))
...
#if QT_CONFIG(tooltip)
        self.createAnother.setToolTip(QCoreApplication.translate("Dialog", u"Check to create several properties in a batch", None))
#endif // QT_CONFIG(tooltip)
