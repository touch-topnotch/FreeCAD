...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.settingsGroup.setToolTip(QCoreApplication.translate("Dialog", u"Includes SetupSheet values in the template. Any SetupSheet values modified from their default are preselected.", None))
#endif // QT_CONFIG(tooltip)
