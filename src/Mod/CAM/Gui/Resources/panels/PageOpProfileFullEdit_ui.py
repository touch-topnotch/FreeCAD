...
#if QT_CONFIG(tooltip)
        self.useCompensation.setToolTip(QCoreApplication.translate("Form", u"If checked, the profile operation is offset by the tool radius. The offset direction is determined by 'Cut side'.", None))
#endif // QT_CONFIG(tooltip)
